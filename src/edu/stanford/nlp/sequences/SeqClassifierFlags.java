...
public class SeqClassifierFlags implements Serializable {
  ...
  // TODO: This should maybe be removed in favor of suppressing splitting when
  // maxDocLength <= 0, when next breaking serialization
  ...
  // evaluate based on B- and I- begin & inside prefixes
  // TODO: it would be useful to serialize the evaluation method
  // TODO: what does this have to do with -iobTags
  public transient boolean evaluateIOB = false;
