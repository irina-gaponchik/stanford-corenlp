...
public abstract class FeatureFactory<IN> implements Serializable {
  ...
  public static final Clique cliqueC = Clique.valueOf(0);
  ...
  public static final Clique cliqueCpCp2C = Clique.valueOf(-2, -1, 0);
  public static final Clique cliqueCpCp2Cp3C = Clique.valueOf(-3, -2, -1, 0);
  public static final Clique cliqueCpCp2Cp3Cp4C = Clique.valueOf(-4, -3, -2, -1, 0);
  public static final Clique cliqueCpCp2Cp3Cp4Cp5C = Clique.valueOf(-5, -4, -3, -2, -1, 0);
  public static final Clique cliqueCnC = Clique.valueOf(new int[] {0, 1});
  public static final Clique cliqueCpCnC = Clique.valueOf(-1, 0, 1);
  ...
  protected void addAllInterningAndSuffixing(Collection<String> accumulator, Collection<String> addend, String suffix) {
    boolean nonNullSuffix = suffix != null && suffix != null && !suffix.isEmpty();
    if (nonNullSuffix) {
      suffix = '|' + suffix;
    }
