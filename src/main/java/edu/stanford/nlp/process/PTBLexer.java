...
class PTBLexer {
  ...
  private Object handleQuotes(String tok, boolean probablyLeft) {
    ...
    } else normTok = asciiQuotes ? asciiQuotes(tok) : tok;
  ...
  private Object handleEllipsis(String tok) {
    ...
    } else return unicodeEllipsis ? getNext(unicodeEllipsisStr, tok) : getNext(tok, tok);
  }
  ...
  private Object getNormalizedAmpNext() {
    String txt = yytext();
      return normalizeAmpersandEntity ? getNext(normalizeAmp(txt), txt) : getNext();
  }
  ...
  public Object next() throws java.io.IOException {
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        ...
        case 50: break;
        case 8:
            return ptb3Dashes ? getNext(ptbmdash, yytext()) : getNext();
          case 51: break;
        case 19:
            return escapeForwardSlashAsterisk ? getNext(delimit(yytext(), '*'), yytext()) : getNext();
          case 52: break;
        case 47: 
        ...
        case 68: break;
        case 6:
            return normalizeOtherBrackets ? getNext(closeparen, yytext()) : getNext();
          case 69: break;
        case 7: 
          { String origTxt = yytext();
        ...
        return getNext(tmp, origTxt);
          case 71: break;
        case 16:
            return normalizeOtherBrackets ? getNext(closebrace, yytext()) : getNext();
          case 72: break;
        case 43:
            yypushback(2) ;
            return getNext();
        ...
        case 25:
          ...
          case 74: break;
        case 18:
            return normalizeParentheses ? getNext(closeparen, yytext()) : getNext();
          case 75: break;
        case 49: 
          { String txt = yytext();
                          if (normalizeSpace) {
        ...
        case 22: 
          ...
          case 78: break;
        case 2:
            return normalizeOtherBrackets ? getNext(openparen, yytext()) : getNext();
          case 79: break;
        case 36: 
          // general lookahead, find correct zzMarkedPos
          { int zzFState = 5;
        ...
        case 80: break;
        case 20:
            return normalizeOtherBrackets ? getNext(openbrace, yytext()) : getNext();
          case 81: break;
        case 17:
            return normalizeParentheses ? getNext(openparen, yytext()) : getNext();
          case 82: break;
        case 11:
        ...
        case 13:
          ...
          case 85: break;
        case 14:
            return normalizeCurrency ? getNext(normalizeCurrency(yytext()), yytext()) : getNext();
          case 86: break;
        case 41: 
          // general lookahead, find correct zzMarkedPos
            int zzFState = 9;
        ...
        case 42: 
          ...
          case 90: break;
        case 12:
            return yylength() >= 3 && yylength() <= 4 && ptb3Dashes ? getNext(ptbmdash, yytext()) : getNext();
          case 91: break;
        case 27:
