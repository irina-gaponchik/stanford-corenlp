...
/**
 * A {@code TreeFactory} acts as a factory for creating objects of
 * class {@code Tree}, or some descendant class.
 * Methods implementing this interface may assume that the {@code List}
...
public interface TreeFactory {
   ...
   *                 may be a (possibly empty) {@code List} of children or
   *                 {@code null}
