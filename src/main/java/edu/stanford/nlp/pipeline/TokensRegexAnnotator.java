...
public class TokensRegexAnnotator implements Annotator {
  ...
  public static void addTokenOffsets(CoreMap annotation)
  {
  ...
  private List extract(CoreMap annotation) {
    List<CoreMap> cms;
      cms = options.extractWithTokens ? extractor.extractCoreMapsMergedWithTokens(annotation) : extractor.extractCoreMaps(annotation);
      return options.flatten ? extractor.flatten(cms) : cms;
  }
