...
public class EnglishUnknownWordModel extends BaseUnknownWordModel {
  ...
  public String getSignature(String word, int loc) {
    TextBuilder sb = new TextBuilder("UNK");
    switch (unknownLevel) {
      case 8: 
  ...
  private void getSignature7(String word, int loc, TextBuilder sb) {
  ...
  private void getSignature6(String word, int loc, TextBuilder sb) {
  ...
  private void getSignature5(String word, int loc, TextBuilder sb) {
  ...
  @SuppressWarnings("MethodMayBeStatic")
  private void getSignature4(String word, int loc, TextBuilder sb) {
    boolean hasDigit = false;
    boolean hasNonDigit = false;
  ...
  @SuppressWarnings("MethodMayBeStatic")
  private void getSignature3(String word, int loc, TextBuilder sb) {
  ...
  @SuppressWarnings("MethodMayBeStatic")
  private void getSignature2(String word, int loc, TextBuilder sb) {
  ...
  @SuppressWarnings("MethodMayBeStatic")
  private void getSignature1(String word, int loc, TextBuilder sb) {
    sb.append('-');
  ...
  private void getSignature8(String word, TextBuilder sb) {
    sb.append('-');
    boolean digit = true;
    for (int i = 0; i < word.length(); i++) {
