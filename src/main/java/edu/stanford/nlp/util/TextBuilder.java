 ...
 *     should be performed with the {@link javolution.text.Text} class directly
 *     (<code>O(Log(n))</code> {@link javolution.text.Text#insert insertion} and
 *     {@link javolution.text.Text#delete deletion} capabilities).</p>
 *
...
public class TextBuilder implements Appendable,
     ...
     */
    public TextBuilder(CharSequence str) {
        this();
        append(str);
    }
     ...
     * @return <code>this</code>
     * @see javolution.text.Text#valueOf(Object)
     */
    public TextBuilder append(Object obj) {
        if (obj instanceof java.lang.String)
            return append((java.lang.String) obj);
    ...
    private TextBuilder appendNumber(Object num) {
        ...
        return append(java.lang.String.valueOf(num));
    }
     ...
     */
    public TextBuilder append(CharSequence csq, int start,
                                      int end) {
        if (csq == null)
            return append("null");
     ...
     * @return <code>this</code>
     */
    public TextBuilder append(java.lang.String str) {
     ...
     */
    public TextBuilder append(java.lang.String str, int start, int end) {
        if (str == null)
            return append("null");
     ...
     * @return <code>this</code>
     */
    public TextBuilder append(javolution.text.Text txt) {
     ...
     */
    public TextBuilder append(javolution.text.Text txt, int start, int end) {
        if (txt == null)
            return append("null");
     ...
     */
    public TextBuilder append(char chars[], int offset, int length) {
     ...
     * @return <code>this</code>
     * @see    javolution.text.TypeFormat
     */
     ...
     */
    public TextBuilder append(double d, int digits,
    ...
    /**
     * Returns the {@link javolution.text.Text} corresponding to this {@link TextBuilder}
     * (allocated on the "stack" when executing in a
     * {@link javolution.context.StackContext StackContext}).
     *
     * @return the corresponding {@link javolution.text.Text} instance.
     */
    public Text toText() {
    ...
    public java.lang.String toString() {
        ...
        return new java.lang.String(data, 0, _length);
    }
     ...
     * {@link TextBuilder}.
     *
     * @return the corresponding {@link javolution.text.CharArray} instance.
     */
     ...
     *        same character content as this text; <code>false</code> otherwise.
     */
    public boolean contentEquals(java.lang.String csq) {
        if (csq.length() != _length)
            return false;
        for (int i = 0; i < _length;) {
            char c = i < C1 ? _low[i] : _high[i >> B1][i & M1];
