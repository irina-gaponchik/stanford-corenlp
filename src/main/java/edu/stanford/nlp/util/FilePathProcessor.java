...
/**
 * The {@code FilePathProcessor} traverses a directory structure and
 * applies the {@code processFile} method to files meeting some
...
public class FilePathProcessor {
   ...
   * @param processor   The {@code FileProcessor} to apply to each
   *                    {@code File}
   */
