 ...
 *          {@link StringBuffer}/{@link java.lang.StringBuilder} in order to manipulate
 *          textual documents (insertion, deletion or concatenation).</li>
 *     <li> Bug free. They are not plagued by the {@link java.lang.String#substring} <a
 ...
 */
public class Text implements CharSequence, Comparable, XMLSerializable,
        ValueType  {
    ...
    public static Text valueOf(Object obj) {
        ...
        return Text.valueOf(java.lang.String.valueOf(obj));
    }
    ...
    private static Text valueOfNumber(Object num) {
        ...
        return Text.valueOf(java.lang.String.valueOf(num));
    }

    private static Text valueOf(java.lang.String str) {
        return Text.valueOf(str, 0, str.length());
    }

    private static Text valueOf(java.lang.String str, int start, int end) {
     ...
     * @return the corresponding instance.
     */
    public static Text valueOf(CharSequence chars) {
        return Text.valueOf(chars, 0, chars.length());
    }
     ...
     *         (length < 0) || ((offset + length) > chars.length)</code>
     */
    public static Text valueOf(CharSequence chars, int offset, int length) {
        if ((offset < 0) || (length < 0) || ((offset + length) > chars.length()))
            throw new IndexOutOfBoundsException();
        if (length <= BLOCK_SIZE) {
            Text text = Text.newPrimitive(length);
            for (int i = 0; i < chars.length(); i++) {
                text._data[i]=chars.charAt(i);
            }
            return text;
        } else { // Splits on a block boundary.
            int half = ((length + BLOCK_SIZE) >> 1) & BLOCK_MASK;
    ...
    private Text append(java.lang.String str) { // Try to append, returns null if cannot.
     ...
     * @return an unique text instance allocated in <code>ImmortalMemory</code>.
     */
    public static Text intern(final java.lang.String str) {
        Text text = (Text) INTERN_INSTANCES.get(str); // Thread-Safe - No entry removed.
        return (text != null) ? text : Text.internImpl(str);
    }

    private static synchronized Text internImpl(final java.lang.String str) {
    ...
    public java.lang.String toString() {
        if (_data != null) { // Primitive.
            return new java.lang.String(_data, 0, _count);
        } else { // Composite.
            char[] data = new char[_count];
            this.getChars(0, _count, data, 0);
            return new java.lang.String(data, 0, _count);
        }
    }
