 ...
 *     should be performed with the {@link Txt} class directly 
 *     (<code>O(Log(n))</code> {@link Txt#insert insertion} and 
 *     {@link Txt#delete deletion} capabilities).</p>
 *
 ...
 */
public class TxtBuilder implements Appendable, CharSequence, Serializable {
     ...
     */
    public TxtBuilder(CharSequence str) {
        this();
        append(str);
    }
     ...
     */
    public TxtBuilder(int capacity) {
        this();
     ...
     * @throws IndexOutOfBoundsException if <code>(newLength < 0)</code>
     */
    public void setLength(int newLength, char fillChar) {
        if (newLength < 0)
            throw new IndexOutOfBoundsException();
    ...
    public java.lang.CharSequence subSequence(int start, int end) {
        if ((start < 0) || (end < 0) || (start > end) || (end > _length))
            throw new IndexOutOfBoundsException();
        return Txt.valueOf(this, start, end);
    }
     ...
     */
    public TxtBuilder append(char c) {
     ...
     * This method is equivalent to <code>append(Txt.valueOf(obj))</code>
     *
     * @param obj the object to represent or <code>null</code>.
     * @return <code>this</code>
     * @see Txt#valueOf(Object)
     */
    public TxtBuilder append(Object obj) {
    ...
    private TxtBuilder appendNumber(Object num) {
     ...
     * @return <code>this</code>
     */
    public TxtBuilder append(java.lang.CharSequence csq) {
     ...
     */
    public TxtBuilder append(java.lang.CharSequence csq, int start,
                                    int end) {
        if (csq == null)
            return append("null");
     ...
     * @return <code>this</code>
     */
    public TxtBuilder append(String str) {
     ...
     */
    public TxtBuilder append(String str, int start, int end) {
        if (str == null)
            return append("null");
     ...
     * @return <code>this</code>
     */
    public TxtBuilder append(Txt txt) {
     ...
     */
    public TxtBuilder append(Txt txt, int start, int end) {
        if (txt == null)
            return append("null");
     ...
     * @return <code>this</code>
     */
    public TxtBuilder append(char chars[]) {
     ...
     */
    public TxtBuilder append(char chars[], int offset, int length) {
     ...
     * @see    TypeFormat
     */
    public TxtBuilder append(boolean b) {
     ...
     * @return <code>this</code>
     */
    public TxtBuilder append(int i) {
        if (i <= 0) {
            if (i == 0)
                return append("0");
     ...
     * @return <code>this</code>
     */
    public TxtBuilder append(int i, int radix) {
        if (radix == 10)
        ...
        if (i < 0) {
            ...
            if (i == Integer.MIN_VALUE) { // Negative would overflow.
                ...
                return (TxtBuilder) append(DIGIT_TO_CHAR[-(i % radix)]);
            }
            i = -i;
        }
     ...
     * @return <code>this</code>
     */
    public TxtBuilder append(long l) {
        if (l <= 0) {
            if (l == 0)
                return append("0");
     ...
     * @return <code>this</code>
     */
    public TxtBuilder append(long l, int radix) {
        if (radix == 10)
        ...
        if (l < 0) {
            ...
            if (l == Long.MIN_VALUE) { // Negative would overflow.
                ...
                return (TxtBuilder) append(DIGIT_TO_CHAR[(int) -(l % radix)]);
            }
            l = -l;
        }
     ...
     */
    public TxtBuilder append(float f) {
     ...
     */
    public TxtBuilder append(double d) {
     ...
     */
    public TxtBuilder append(double d, int digits,
     ...
     *         (index > this.length())</code>
     */
    public TxtBuilder insert(int index, java.lang.CharSequence csq) {
        if ((index < 0) || (index > _length))
     ...
     *         || (start > end) || (end > this.length())</code>
     */
    public TxtBuilder delete(int start, int end) {
    ...
    /**
     * Returns the {@link Txt} corresponding to this {@link TxtBuilder}
     * (allocated on the "stack" when executing in a 
     * {@link javolution.context.StackContext StackContext}).
     *
     * @return the corresponding {@link Txt} instance.
     */
    public Txt toText() {
        return Txt.valueOf(this, 0, _length);
    }
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof TxtBuilder))
            return false;
        TxtBuilder that = (TxtBuilder) obj;
